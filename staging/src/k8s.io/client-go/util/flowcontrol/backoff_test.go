...
func TestIsInBackOffSince(t *testing.T) {
	...
	cases := []struct {
		...
		{tick: 22, inBackOff: true, value: 1},
		{tick: 23, inBackOff: true, value: 1},
		{tick: 24, inBackOff: true, value: 1},
		{tick: 25, inBackOff: true, value: 1},
		{tick: 26, inBackOff: true, value: 1},
		{tick: 27, inBackOff: true, value: 1},
		{tick: 28, inBackOff: true, value: 1},
		{tick: 29, inBackOff: true, value: 1},
		{tick: 30, inBackOff: true, value: 1},
		{tick: 31, inBackOff: true, value: 1},
		{tick: 32, inBackOff: true, value: 1},
		{tick: 33, inBackOff: true, value: 1},
		{tick: 34, inBackOff: true, value: 1},
		{tick: 35, inBackOff: true, value: 1},
		{tick: 56, inBackOff: false, value: 0},
		{tick: 57, inBackOff: true, value: 1},
	}
