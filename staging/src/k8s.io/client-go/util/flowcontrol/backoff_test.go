...
func TestIsInBackOffSinceUpdate(t *testing.T) {
	...
	cases := []struct {
		...
		{tick: 57, inBackOff: true, value: 10},
	}

	for _, c := range cases {
		tc.SetTime(startTime.Add(c.tick * step))
		if inBackOff := b.IsInBackOffSinceUpdate(id, tc.Now()); c.inBackOff != inBackOff {
			t.Errorf("expected IsInBackOffSinceUpdate %v got %v at tick %s", c.inBackOff, inBackOff, c.tick*step)
		}
...
func TestIsInBackOffSince(t *testing.T) {
	...
	cases := []struct {
		...
		{tick: 0, inBackOff: false, value: 0},
		{tick: 1, inBackOff: true, value: 1},
		{tick: 2, inBackOff: true, value: 1},
		{tick: 3, inBackOff: true, value: 1},
		{tick: 4, inBackOff: true, value: 1},
		{tick: 5, inBackOff: true, value: 1},
		{tick: 6, inBackOff: true, value: 1},
		{tick: 7, inBackOff: true, value: 1},
		{tick: 8, inBackOff: true, value: 1},
		{tick: 9, inBackOff: true, value: 1},
		{tick: 10, inBackOff: true, value: 1},
		{tick: 11, inBackOff: true, value: 1},
		{tick: 12, inBackOff: true, value: 1},
		{tick: 13, inBackOff: true, value: 1},
		{tick: 14, inBackOff: true, value: 1},
		{tick: 15, inBackOff: true, value: 1},
		{tick: 16, inBackOff: true, value: 1},
		{tick: 17, inBackOff: true, value: 1},
		{tick: 18, inBackOff: true, value: 1},
		{tick: 19, inBackOff: true, value: 1},
		{tick: 20, inBackOff: true, value: 1},
		{tick: 21, inBackOff: false, value: 1},
		{tick: 22, inBackOff: true, value: 2},
		{tick: 23, inBackOff: true, value: 2},
		{tick: 24, inBackOff: true, value: 2},
		{tick: 25, inBackOff: true, value: 2},
		{tick: 26, inBackOff: true, value: 2},
		{tick: 27, inBackOff: true, value: 2},
		{tick: 28, inBackOff: true, value: 2},
		{tick: 29, inBackOff: true, value: 2},
		{tick: 30, inBackOff: true, value: 2},
		{tick: 31, inBackOff: true, value: 2},
		{tick: 32, inBackOff: true, value: 2},
		{tick: 33, inBackOff: true, value: 2},
		{tick: 34, inBackOff: true, value: 2},
		{tick: 35, inBackOff: true, value: 2},
		{tick: 56, inBackOff: false, value: 0},
		{tick: 57, inBackOff: true, value: 4},
	}

	for _, c := range cases {
		tc.SetTime(startTime.Add(c.tick * step))
		if inBackOff := b.IsInBackOffSince(id, tc.Now()); c.inBackOff != inBackOff {
			t.Errorf("expected IsInBackOffSince %v got %v at tick %s", c.inBackOff, inBackOff, c.tick*step)
		}
